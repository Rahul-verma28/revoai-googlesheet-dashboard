...
const isValidSheetId = (sheetId: string): boolean => {
  const sheetIdRegex = /^[a-zA-Z0-9-_]{44}$/; // Google Sheet IDs are typically 44 characters long
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  if (!isValidSheetId(formData.sheetId)) {
